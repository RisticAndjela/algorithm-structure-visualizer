...
builder.Services.AddScoped<KnnSimulation>();
builder.Services.AddScoped<KdTreeSimulation>();
builder.Services.AddScoped<KMeansSimulation>();
builder.Services.AddScoped<DecisionTreeSimulation>();
builder.Services.AddScoped<PcaSimulation>();
builder.Services.AddScoped<NeuronSimulation>();
builder.Services.AddScoped<MlpSimulation>();
builder.Services.AddScoped<BackpropagationSimulation>();
builder.Services.AddScoped<OptimizerSimulation>();
builder.Services.AddScoped<SparseMatrixSimulation>();
builder.Services.AddScoped<PageRankSimulation>();
builder.Services.AddScoped<SpectralClusteringSimulation>();
builder.Services.AddScoped<MessagePassingSimulation>();
